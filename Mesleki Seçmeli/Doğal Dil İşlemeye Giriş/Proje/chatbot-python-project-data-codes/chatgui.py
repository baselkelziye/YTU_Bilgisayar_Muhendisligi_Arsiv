...
def send():
    ...
    if msg != '':
        ...
        #Türkçe kullanım için
        #try:
        #    msg = translator.translate(msg,dest='en',source='tr').text
        #    try:
        #        res = chatbot_response(msg)
        #    except:
        #        res ="Sorry. I can't understand you. Please tell me different way. :("
        #except:
        #    res ="İnternet bağlantınızı kontrol ediniz."
        #try:
        #    res = translator.translate(res,'tr',source='en').text
        #except:
        #    res ="İnternet bağlantınızı kontrol ediniz."
