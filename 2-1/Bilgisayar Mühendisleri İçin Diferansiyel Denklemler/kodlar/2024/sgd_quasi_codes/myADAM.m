...
%     x_new = x_old - ap_H\dfV; % approx hessian: outer products of gradyan kullanan
    ...
    % ADAM
    m(:,t)=b1*m(:,t-1)+(1-b1)*dfV; % b1 kuculdukce oncesinin etkisi azalýyor, simdinin etkisi artiyor, dolayýsýyla m daha cok saliniyor
...
Xs(:,t-1) % son deðer
mean(Xs(:,2:t-1)') % tüm degerlerin ortalamasý
