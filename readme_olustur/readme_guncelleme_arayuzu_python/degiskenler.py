...
DERS_TIPLERI = [ZORUNLU,MESLEKI_SECMELI,MESLEKI_SECMELI_1,MESLEKI_SECMELI_2,UNIVERSITE_MESLEKI_SECMELI,SECMELI,SOSYAL_SECMELI_1,  UNIVERSITE_SOSYAL_SECMELI]
