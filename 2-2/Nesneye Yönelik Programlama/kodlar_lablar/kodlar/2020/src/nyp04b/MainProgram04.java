...
public class MainProgram04 {
	...
	public static void main(String[] args) {
		...
		Car bmw = new Car("34 RA 440", null, cars4U);
		Car audi = new Car("06 AC 432",null, cars4U);
		if( cars4U.addCar(bmw) ) {
			System.out.println("Adding operation errornously succeeded.");
		}
		else {
			System.out.println("Adding operation successfully failed as"
					+ " it has already been added in the Car constructor");
		}
		cars4U.addCar(audi);
