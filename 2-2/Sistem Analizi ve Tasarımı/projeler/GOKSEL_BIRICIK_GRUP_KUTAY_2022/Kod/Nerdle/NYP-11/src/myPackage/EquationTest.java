...
public class EquationTest {
	...
	//DenklemKontrol sýnýfýmýn isCorrect metoduyla üretilen denklemleri kontrol ediyorum.
	...
	//MyClass sýnýfýmýn setEsitlik metodunu kullanarak yanlýþ deðerlerle DenklemKontrol sýnýfýmýn isCorrect metodunu kontrol ediyorum.
	...
	//MyClass sýnýfýmýn setEsitlik metodunu kullanarak doðru deðerlerle DenklemKontrol sýnýfýmýn isCorrect metodunu kontrol ediyorum.
	...
	//MyClass sýnýfýmýn generateEquation metoduyla üretilen denklerde iþlemlerin varlýðýný kontrol ediyorum.
	...
	//MyClass sýnýfýmýn generateEquation metoduyla üretilen denklerde eþittir varlýðýný kontrol ediyorum.
	...
	//MyClass sýnýfýmýn generateEquation metoduyla üretilen denklerde eþittirden sonra geçerli deðerin varlýðýný kontrol ediyorum.
	...
	//MyClass sýnýfýmýn generateEquation metoduyla üretilen denklerde en az 2 sayýnýn varlýðýný kontrol ediyorum.
