...
- 💡 **Staj**
  ...
  - 📘 **S: Nasıl Staj Saydırırım?** **C:**  Dilekçe ve ek olarak 3 belge talep ediliyor.  Kendinize göre doldurabileceğiniz dilekçe formunun drive [linki](https://docs.google.com/document/d/1lkJ6E-jIg8mp8g3hCzh5uvklWCi_I1JWKqmlZHRh6x0/edit?usp=sharing), **Sigortalı İşe Giriş Bildirgesi, Sigorta Tescil ve Hizmet Dökümü, 4a Sigortalı Tescil Kaydı**.Bu belgelerin tamamı e-devlet üzerinde mevcut. Geçmişe yönelik çalışmanız bu şekilde otomatik olarak staj olarak sayılacak. Ekstra olarak staj defteri doldurma, şirkete belge imzalatma gibi süreçlerden muafsınız. Ek olarak staj yapılan yerin **Bilgisayar Mühendisliği** alanında faaliyet göstermesi gerekiyor Lütfen bunu gözden kaçırmayın.
- 💡 **Vize**
...
#### 📘 Bilgisayar Bilimlerine Giriş 👑 En popüler ders (9 oy)
  - 🏷️ **Ders Tipi:** Zorunlu
  - 💭 **Öğrenci Görüşleri:**
...
- 💬 **Öğrenci Görüşleri:**
  ...
  - 👤 **_Anonim_**: Kendisinden bitirme ve ders aldım. Çok tatlı hoca. Sesi podcastlik. Bitirmede çok yardımcı oldu oneririm
  - ℹ️ Siz de [linkten](https://forms.gle/WbwDxHUz6ebJA7t36) anonim şekilde görüşlerinizi belirtebilirsiniz.
- 📚 **Verdiği Dersler:**
  - 📖 [Veri Yapıları ve Algoritmalar](#-veri-yapıları-ve-algoritmalar)
  - 📖 [Bilgisayar Bilimlerine Giriş](#-bilgisayar-bilimlerine-giriş--en-popüler-ders-9-oy)
